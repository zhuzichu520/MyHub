...
import com.zhuzichu.android.search.databinding.FragmentSearchRepositoriesBinding
 ...
 * since: v 1.0.0
 */
class FragmentSearchRepositoriess :
    FragmentBase<FragmentSearchRepositoriesBinding, ViewModelSearchRepositories, ArgSearch>() {

    override fun bindVariableId(): Int = BR.viewModel

    override fun setLayoutId(): Int = R.layout.fragment_search_repositories
    ...
    override fun initViewObservable() {
        ...
        share.onRepositoriesSearchChangeEvent.observe(viewLifecycleOwner) {
            showLoading()
            viewModel.page = 1
            viewModel.loadData {
                hideLoading()
